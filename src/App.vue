...
onMounted(() => {
  ...
  const title2 = `
         ___                 __             
   ____ <  /___ _____  _____/ /_  ___  ____ 
  / __ \\/ / __ \`/ __ \\/ ___/ __ \\/ _ \\/ __ \\
 / / / / / /_/ / / / / /__/ / / /  __/ / / /
/_/ /_/_/\\__,_/_/ /_/\\___/_/ /_/\\___/_/ /_/ `;
  const content = `\n\n版本: ${config.version}\n主页: ${config.home}\nGithub: ${config.github}`;
  const content_original = `\n\n原作者: imsyy\n主页: https://imsyy.top\nGithub: https://github.com/imsyy/home`;
  console.info(`%c${title1} %c${title2} %c${content} %c${content_original}`, styleTitle1, styleTitle2, styleContent, styleContent);
});
